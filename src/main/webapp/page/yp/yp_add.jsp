...
<div>
    ...
    <form id="yp_form" method="post" class="easyui-form">
        <table cellpadding="5">
            ...
            <tr>
                <td>接口类型:</td>
                <td><input class="easyui-textbox" type="text" name="jklx"></input></td>
            </tr>
            <tr>
                <td>转速:</td>
                <td><input class="easyui-textbox" type="text" name="zs"></input></td>
            </tr>
            <tr>
                <td>缓存:</td>
                <td><input class="easyui-textbox" type="text" name="hc"></input></td>
            </tr>
            <tr>
                <td>尺寸:</td>
