...
<div align="center" >
    <div align="center">
        <br>
        <c:if test="${sessionScope.myComputer.size()==0}">配置单为空</c:if>
        <c:forEach items="${sessionScope.myComputer}" var="computer">
            <table border="1" width="500px">
                <tr><td colspan="3" class="bluetd"></td></tr>
                ...
                <tr><td colspan="3" class="bluetd"><input type="button" value="删除配置单" onclick="delete2(${computer.id})"></td></tr>
            </table>
            <br>
        </c:forEach>
    </div>
...
<script>
    function delete2 (id) {
        ...
        //window.location.href="<%=path %>/user/delete2?id="+id;
    }
</script>
</html>