...
<div>
    ...
    <form id="zb_form" method="post" class="easyui-form">
        <table cellpadding="5">
            ...
            <tr>
                <td>主芯片组:</td>
                <td><input class="easyui-textbox" type="text" name="zxpz"></input></td>
            </tr>
            <tr>
                <td>插槽:</td>
            ...
            <tr>
                <td>板型:</td>
                <td><input class="easyui-textbox" type="text" name="bx"></input></td>
            </tr>
            <tr>
                <td>集成芯片:</td>
                <td><input class="easyui-textbox" type="text" name="jcxp"></input></td>
            </tr>
            <tr>
                <td>内存类型:</td>
                <td><input class="easyui-textbox" type="text" name="nclx"></input></td>
            </tr>
            <tr>
                <td>描述:</td>
